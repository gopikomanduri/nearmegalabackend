...
public class FirebaseMessagingClient {
    ...
    private static final Logger LOGGER = Logger.getLogger(FirebaseMessagingClient.class.getName());
     ...
     */
    public FirebaseMessagingClient(String fcmSendEndpoint) {
     ...
     * Where is server API key. Open {@link //console.firebase.google.com}
    ...
    public FcmResponse pushNotify(JSONObject json) {
        ...
        try {
            ...
            System.out.println("requestText is =" + requestText);
